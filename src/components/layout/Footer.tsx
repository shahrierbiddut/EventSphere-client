  ...
  return (
    <footer className="bg-card text-muted-foreground border-t border-border">
      <div className="container mx-auto px-4 md:px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-sm text-muted-foreground max-w-sm">
              Discover, create, manage, and experience events seamlessly. Join
              the community of event enthusiasts and creators making memories
              around the globe.
            </p>
            <div className="flex gap-4">
              <Link
                href="https://www.facebook.com/share/1Er8DaKmmf/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#1877F2] hover:text-[#165EC7] transition-colors"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#E4405F] hover:text-[#D43A50] transition-colors"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <Link
                href="https://linkedin.com/in/shahrier-hossain-biddut"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#0A66C2] hover:text-[#0850A1] transition-colors"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <Link
                href="https://wa.me/qr/WYIBBSODTPF4E1"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#25D366] hover:text-[#1FA954] transition-colors"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="24"
          ...
          {/* Explore */}
          <div className="space-y-6">
            <h4 className="text-foreground font-semibold tracking-wide">Explore</h4>
            <ul className="space-y-3 text-sm">
              <li>
                <Link
                  href="/explore"
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>
                  123 Event Avenue, Tech District
                  <br />
        ...
        {/* Newsletter & Bottom */}
        <div className="border-t border-border pt-8 mt-8 flex flex-col lg:flex-row items-center justify-between gap-6">
