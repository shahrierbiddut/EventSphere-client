...
export default function AboutPage() {
  return (
    <div className="bg-card">
      {/* Hero Section */}
      <section className="relative w-full py-20 lg:py-32 bg-muted overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              <h2 className="text-3xl font-bold font-heading text-foreground">Our Story</h2>
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-card p-8 md:p-12 rounded-3xl shadow-sm border border-primary/10 relative overflow-hidden group hover:shadow-xl transition-all">
            ...
            <div className="bg-card p-8 md:p-12 rounded-3xl shadow-sm border border-secondary/10 relative overflow-hidden group hover:shadow-xl transition-all">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center p-6 text-center">
                <div className="w-14 h-14 bg-muted rounded-full flex items-center justify-center text-foreground mb-6 shadow-sm border border-border">
