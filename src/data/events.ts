...
export const events: Event[] = [
  {
    ...
    description: "The Global Tech Summit 2025 brings together industry leaders, innovators, and tech enthusiasts from around the world. Over three days, experience keynote speeches from renowned tech visionaries, interactive workshops, and unparalleled networking opportunities. Discover the latest trends in Artificial Intelligence, Web3, Cyber Security, and Cloud Computing.",
    isFeatured: true
  },
  {
    id: "e2",
    ...
    description: "Connect with fellow founders, share experiences, and pitch your ideas to potential investors in a relaxed, informal setting. This mixer is designed to foster collaboration and growth within the local startup ecosystem.",
    isFeatured: true
  },
  {
    id: "e3",
    ...
    description: "Experience the magic of classical music in an open-air setting. Bring your family and friends for a memorable night featuring masterpieces by Mozart, Beethoven, and Tchaikovsky, performed by world-class musicians.",
    isFeatured: false
  },
  {
    id: "e4",
    ...
    description: "A comprehensive online masterclass designed for marketers looking to level up their skills. Covering the latest algorithms, effective ad spend strategies, and data-driven content creation.",
    isFeatured: true
  },
  {
    id: "e5",
    ...
    shortDescription: "Discover contemporary artworks from emerging and established artists across the country.",
    description: "The annual National Art Exhibition showcases a diverse range of mediums including painting, sculpture, photography, and digital art. A must-visit event for art lovers, collectors, and creatives.",
    isFeatured: false
  },
  {
    id: "e6",
    ...
    shortDescription: "Taste the world in one place! Over 100 stalls featuring authentic cuisines from 20+ countries.",
    description: "A gastronomic adventure awaits! Enjoy live cooking demonstrations, food tasting sessions, and live entertainment. Bring your appetite and explore diverse culinary traditions.",
    isFeatured: true
  },
  {
    id: "e7",
